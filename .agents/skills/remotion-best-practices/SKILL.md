...
description: Apply best practices for Remotion video creation in React. Use when writing Remotion compositions, debugging render issues, or following framework conventions.
metadata:
