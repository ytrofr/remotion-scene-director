...
export const HAND_PHYSICS = {
  scroll: {
    floatAmplitude: 0, floatSpeed: 0,
    velocityScale: 0.1, maxRotation: 5,
    shadowEnabled: true, shadowDistance: 8, shadowBlur: 10,
    smoothing: 0.2,
  },
  tap: {
    floatAmplitude: 2, floatSpeed: 0.04,
    velocityScale: 0.6, maxRotation: 25,
    shadowEnabled: true, shadowDistance: 10, shadowBlur: 12,
    smoothing: 0.15,
  },
  trail: {
    floatAmplitude: 0, floatSpeed: 0,
    velocityScale: 0.8, maxRotation: 35,
    shadowEnabled: true, shadowDistance: 8, shadowBlur: 10,
    smoothing: 0.2,
  },
};
