/**
 * DorianFullV1_10 — V1.10 of DorianFull.
 *
 * Diff vs V1.09:
 *   - Uses DorianDemoV1_10 (scene 9 ProductDetail prepended with big
 *     scrollbar-drag before existing click sequence).
 *   - Replaces StoreDashboardScene with StoreDashboardSceneV1_10 — adds
...
import {
  DorianDemoV1_10,
  SCENES_V1_10 as DORIAN_SCENES,
} from '../DorianDemo/DorianDemoV1.10';
import { OutroScene } from '../DorianDemo/scenes/OutroScene';
import { SCENES as STORES_SCENES, COLORS } from '../DorianStores/constants';
import { StoreDashboardSceneV1_10 } from '../DorianStores/scenes/StoreDashboardSceneV1.10';
...
export const FULL_SCENE_INFO_V1_10 = [
  {
    name: '1-Intro',
  ...
  },
  {
    ...
    end: FULL_VIDEO_V1_10.durationInFrames,
  },
];
...
const StoresAudioFromLayersV1_10: React.FC = () => {
...
const DorianFullStoresAudioV1_10: React.FC = () => {
  ...
  for (const scene of STORES_AUDIO_SCENES) {
    const entries = [
      ...
      ...getCodedAudio('DorianFullV1.10', scene.name),
    ];
...
const PageLoadOverlayV1_10: React.FC = () => {
...
export const DorianFullV1_10: React.FC = () => {
  return (
    <AbsoluteFill style={{ background: '#FFFFFF' }}>
      <DorianFullStoresAudioV1_10 />
      <StoresAudioFromLayersV1_10 />
      ...
      <Sequence
        ...
        name="DorianDemo-Part-V1.10"
      >
        <DorianDemoV1_10 />
      </Sequence>

      <PageLoadOverlayV1_10 />
    </AbsoluteFill>
  );
};
