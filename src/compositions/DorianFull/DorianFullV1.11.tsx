/**
 * DorianFullV1_11 — V1.11 of DorianFull.
 *
 * Diff vs V1.09:
 *   - Uses DorianDemoV1_11 (scene 9 ProductDetail prepended with big
 *     scrollbar-drag before existing click sequence).
 *   - Replaces StoreDashboardScene with StoreDashboardSceneV1_11 — adds
...
import {
  DorianDemoV1_11,
  SCENES_V1_11 as DORIAN_SCENES,
} from '../DorianDemo/DorianDemoV1.11';
import { OutroScene } from '../DorianDemo/scenes/OutroScene';
import { SCENES as STORES_SCENES, COLORS } from '../DorianStores/constants';
import { StoreDashboardSceneV1_11 } from '../DorianStores/scenes/StoreDashboardSceneV1.11';
...
export const FULL_SCENE_INFO_V1_11 = [
  {
    name: '1-Intro',
  ...
  },
  {
    ...
    end: FULL_VIDEO_V1_11.durationInFrames,
  },
];
...
const StoresAudioFromLayersV1_11: React.FC = () => {
...
const DorianFullStoresAudioV1_11: React.FC = () => {
  ...
  for (const scene of STORES_AUDIO_SCENES) {
    const entries = [
      ...
      ...getCodedAudio('DorianFullV1.11', scene.name),
    ];
...
const PageLoadOverlayV1_11: React.FC = () => {
...
export const DorianFullV1_11: React.FC = () => {
  return (
    <AbsoluteFill style={{ background: '#FFFFFF' }}>
      <DorianFullStoresAudioV1_11 />
      <StoresAudioFromLayersV1_11 />
      ...
      <Sequence
        ...
        name="DorianDemo-Part-V1.11"
      >
        <DorianDemoV1_11 />
      </Sequence>

      <PageLoadOverlayV1_11 />
    </AbsoluteFill>
  );
};
