/**
 * DorianFullV1_21 — V1.21 of DorianFull.
 *
 ...
 *      DorianFullV1-21/8-ProductPage.secondaryLayers) — pointer trail from
 ...
 *      navigation. Wired via CODED_CLICK_FLASH_REGISTRY[DorianFullV1-21] in
 ...
 *
 * Architecture: V1.21 STOPS wrapping V1.20 (which wrapped V1.13). It builds
...
// ── V1.21 scene-8 extension config ─────────────────────────────────────────
...
const SCENE_OVERRIDES_V1_21: SceneOverridesV1_12 = {
  productPage: {
    duration: 220,
    sceneConfig: {
      tvCardX: 518,
...
const DORIAN_SCENES_V1_21 = resolveScenesV1_12(SCENE_OVERRIDES_V1_21);
// Sanity: build-time confirmation the cascade resolves to the expected total.
void resolveDurationV1_12(SCENE_OVERRIDES_V1_21);

const DORIAN_CUT =
  DORIAN_SCENES_V1_21.productDetail.start +
  DORIAN_SCENES_V1_21.productDetail.duration;
...
const CLOSING_DURATION = DORIAN_SCENES_V1_21.outro.duration;

const LOADER_END = STORES_OFFSET + 25;

export const FULL_VIDEO_V1_21 = {
  width: 1080,
  height: 1920,
  fps: 30,
...
export const FULL_SCENE_INFO_V1_21 = [
  {
    name: '1-Intro',
    start: DORIAN_SCENES_V1_21.intro.start,
    end: DORIAN_SCENES_V1_21.intro.start + DORIAN_SCENES_V1_21.intro.duration,
  },
  {
    name: '2-HomeScroll',
    start: DORIAN_SCENES_V1_21.homeScroll.start,
    end:
      DORIAN_SCENES_V1_21.homeScroll.start +
      DORIAN_SCENES_V1_21.homeScroll.duration,
  },
  {
    name: '3-TapBubble',
    start: DORIAN_SCENES_V1_21.tapBubble.start,
    end:
      DORIAN_SCENES_V1_21.tapBubble.start +
      DORIAN_SCENES_V1_21.tapBubble.duration,
  },
  {
    name: '4-ChatOpen',
    start: DORIAN_SCENES_V1_21.chatOpen.start,
    end:
      DORIAN_SCENES_V1_21.chatOpen.start +
      DORIAN_SCENES_V1_21.chatOpen.duration,
  },
  {
    name: '5-UserTyping',
    start: DORIAN_SCENES_V1_21.userTyping.start,
    end:
      DORIAN_SCENES_V1_21.userTyping.start +
      DORIAN_SCENES_V1_21.userTyping.duration,
  },
  {
    name: '6-AIThinking',
    start: DORIAN_SCENES_V1_21.aiThinking.start,
    end:
      DORIAN_SCENES_V1_21.aiThinking.start +
      DORIAN_SCENES_V1_21.aiThinking.duration,
  },
  {
    name: '7-AIResponse',
    start: DORIAN_SCENES_V1_21.aiResponse.start,
    end:
      DORIAN_SCENES_V1_21.aiResponse.start +
      DORIAN_SCENES_V1_21.aiResponse.duration,
  },
  {
    name: '8-ProductPage',
    start: DORIAN_SCENES_V1_21.productPage.start,
    end:
      DORIAN_SCENES_V1_21.productPage.start +
      DORIAN_SCENES_V1_21.productPage.duration,
  },
  {
    name: '9-ProductDetail',
    start: DORIAN_SCENES_V1_21.productDetail.start,
    end: DORIAN_CUT,
  },
  {
  ...
  },
  {
    ...
    end: FULL_VIDEO_V1_21.durationInFrames,
  },
];
...
const StoresAudioFromLayersV1_21: React.FC = () => {
...
const DorianFullStoresAudioV1_21: React.FC = () => {
  ...
  for (const scene of STORES_AUDIO_SCENES) {
    const entries = [
      ...
      ...getCodedAudio('DorianFullV1-21', scene.name),
    ];
...
const PageLoadOverlayV1_21: React.FC = () => {
...
const SoundtrackV1_21: React.FC = () => {
  const isSceneDirector = useSceneDirectorMode();
  if (isSceneDirector) return null;
  return (
    <BackgroundMusic
...
const CLICK_FLASH_SCENE_OFFSETS: Record<string, number> = {
  '1-Intro': DORIAN_SCENES_V1_21.intro.start,
  '2-HomeScroll': DORIAN_SCENES_V1_21.homeScroll.start,
  '3-TapBubble': DORIAN_SCENES_V1_21.tapBubble.start,
  '4-ChatOpen': DORIAN_SCENES_V1_21.chatOpen.start,
  '5-UserTyping': DORIAN_SCENES_V1_21.userTyping.start,
  '6-AIThinking': DORIAN_SCENES_V1_21.aiThinking.start,
  '7-AIResponse': DORIAN_SCENES_V1_21.aiResponse.start,
  '8-ProductPage': DORIAN_SCENES_V1_21.productPage.start,
  '9-ProductDetail': DORIAN_SCENES_V1_21.productDetail.start,
...
export const DorianFullV1_21: React.FC = () => {
  return (
    <ClickStyleProvider value="soft-pulse">
      <AbsoluteFill style={{ background: '#FFFFFF' }}>
        <DorianFullStoresAudioV1_21 />
        <StoresAudioFromLayersV1_21 />
        <SoundtrackV1_21 />
        ...
        <Sequence
          ...
          name="DorianDemo-Part-V1.21"
        >
          <DorianDemoV1_12 sceneOverrides={SCENE_OVERRIDES_V1_21} />
        </Sequence>
        ...
        <ClickFlashFromRegistry
          compositionId="DorianFullV1-21"
          sceneOffsets={CLICK_FLASH_SCENE_OFFSETS}
        />

        <PageLoadOverlayV1_21 />
      </AbsoluteFill>
    </ClickStyleProvider>
  );
};
