...
// V1.11 — locked-rotation scrollbar physics (matches DorianDemo.scrollbar
// preset used in V1.09 scenes 2 + 8). Defined inline to avoid touching
// frozen DorianStores/constants.ts.
const SCROLLBAR_PHYSICS_V1_11 = {
  floatAmplitude: 0,
  floatSpeed: 0,
  velocityScale: 0,
  maxRotation: 0,
...
export const StoreDashboardSceneV1_11: React.FC = () => {
  ...
  // V1.11: Phase 9 — best-sellers scroll. BIG scrollbar drag at right edge
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.white }}>
      ...
      {/* V1.11 Hand cursor - phase 9 (best-sellers scrollbar drag) */}
      {frame >= 360 && frame < 460 && (
        <FloatingHand
          path={handPath2}
          startFrame={0}
          ...
          dark={false}
          showRipple={false}
          physics={SCROLLBAR_PHYSICS_V1_11}
        />
      )}
